        ...
        <div className="flex-1 bg-gradient-to-br from-[#eafaf1] to-white flex flex-col justify-center p-8 md:p-12">
          ...
          <form onSubmit={handleSignIn} className="bg-white rounded-xl shadow-md p-6 flex flex-col gap-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="bg-[#00bf63] text-white font-bold py-3 rounded-lg transition duration-300 hover:bg-[#00994f] hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? 'Signing In...' : 'Sign In'}
            </button>

            <div className="text-center">
              <a href="#" className="text-sm text-[#00bf63] hover:underline">
                Forgot Password?
              </a>
            </div>
          </form>
